...
class _PredictionScreenState extends State<PredictionScreen> {
  ...
  Future<void> speakText(String text) async {
    await flutterTts.setLanguage("ur-PK");   // you can change language if needed
    await flutterTts.setPitch(1.0);          // 0.5–2.0 range
  ...
  Future<void> _sendRequest() async {
    try {
      ...
      final response = await apiService.sendPredictionRequest(data);
      print(response);
      await speakText(response.toString());
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Prediction API Example")),
      body: Center(
        child: Column(
