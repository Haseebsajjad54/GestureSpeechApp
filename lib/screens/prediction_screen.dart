...
class GloveConnectionScreen extends StatelessWidget {
   GloveConnectionScreen({super.key});
  final ApiService _apiService = ApiService();
   ...
   final List<List<dynamic>> lerkihe = [
              ...
              builder: (context, controller, child) {
                return Column(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: ()async{
                        final response= await _apiService.sendPredictionRequest(rona);
                        print(response);
                      },
                      icon: const Icon(Icons.bluetooth_disabled),
                      label: const Text("Check Prediction"),
                    ),
